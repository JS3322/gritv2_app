...
class _OnOffSwitchState extends State<OnOffSwitch> {
  ...
  Color _get_balck_to_yellow_Color() {
  //450l0-560.0;
  return Color.lerp(
  ...
  double _get_opacity() {
    return prefix0.lerpDouble(0.9, 0.2, (_switchBtnPostionY - 450.0) / (560.0 - 450.0));  
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _get_balck_to_yellow_Color(),// Color.fromARGB(255, 243, 215, 27), //Color.fromARGB(255, 33, 31, 42)
      body: Stack(
          children: <Widget>[
            AppBar(
              ...
              leading: FlatButton(
                ...
                child: Icon(Icons.arrow_back_ios,
                  color: _get_white_to_black_Color()), // Icon
              ),
            ),
            //left text
            Align(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.black.withOpacity(_get_opacity()),
