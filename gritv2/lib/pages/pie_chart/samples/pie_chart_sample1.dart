        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Indicator(color: Color(0xff0293ee), text: "공감", isSquare: false,
                  size: touchedIndex == 0 ? 18 : 16,
                  textColor: touchedIndex == 0 ? Colors.black : Colors.grey,),
                Indicator(color: Color(0xfff8b250), text: "끈기", isSquare: false,
                  size: touchedIndex == 1 ? 18 : 16,
                  textColor: touchedIndex == 1 ? Colors.black : Colors.grey,),
                Indicator(color: Color(0xff845bef), text: "감정조절", isSquare: false,
                  size: touchedIndex == 2 ? 18 : 16,
                  textColor: touchedIndex == 2 ? Colors.black : Colors.grey,),
                Indicator(color: Color(0xff13d38e), text: "낙관성", isSquare: false,
